...
export function MasterProfileEditor({ profile, resumeId, onSave, isSaving }: MasterProfileEditorProps) {
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between sticky top-0 bg-background/95 backdrop-blur z-10 py-4 border-b px-1">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h2 className="text-xl font-bold tracking-tight">Master Profile</h2>
                        <p className="text-xs text-muted-foreground">Source of truth for all your resumes</p>
                    </div>
                </div>
                ...
                <Accordion type="multiple" defaultValue={["contact", "summary"]} className="w-full space-y-4">
                    ...
                    <AccordionItem value="experience" className="border rounded-lg bg-card px-4">
                        ...
                        <AccordionContent className="pt-2 pb-6 space-y-4">
                            ...
                            <Button variant="outline" className="w-full border-dashed py-6 text-muted-foreground hover:text-foreground" onClick={() => {
