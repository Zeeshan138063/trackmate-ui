...
export function EuropassTemplate({ data, className }: EuropassTemplateProps) {
    ...
    return (
        <div className={cn("bg-white text-black max-w-[8.5in] mx-auto min-h-[11in] text-sm font-sans flex shadow-lg print:shadow-none print:w-full print:max-w-none", className)} id="resume-preview">
